...
Family Hub has been running on the kitchen tablet for months now. My daughter uses it to check the week's schedule. My partner uses the meal planner. I use the to-do list and news digest. The whiteboard is still there — but now it's a convenient input device rather than the source of truth.
