...
description: |
  ...
  striking statistic: of all the occupations in the 1950 US census,
  only one (elevator operator) had fully disappeared by the 2010s. I
  tested the claim against Australian data, comparing the 1966 ABS
  census occupation tables to Jobs and Skills Australia's Feb 2026
  ANZSCO employment numbers.
author:
  - name: Pat Reen
...
In *A World Without Work* (Allen Lane, 2020), Daniel Susskind notes
that of all the occupations in the 1950 US census, only one (elevator
...
occupation out. It seems to set up an argument that this pattern may
not hold for what's coming next.
...
1. **Nine 1966 occupations have no current equivalent in the
   classification.** More than Susskind's one, but my 28 are a
   hand-picked sample of likely disappearances rather than a scan of
   the whole 1966 classification, and Australia carried primary-
   industry occupations (whalers, pearlers, tanners) the 1950 US one
   didn't. Causes vary: automation, fashion, regulation, offshoring.
2. **The bigger story is share-of-work decay, not extinction.**
   ...
   Today's 4,800 are mostly specialist roles: legal and medical
   transcriptionists, court reporters, real-time captioners (the JSA
   row shows 63% part-time). Typing as a craft survived where speed
   and accuracy still earn their own job; typing as a general task
   got everyone.
...
One caveat up front: there's no lift-attendant in the 1966
Australian census (presumably absorbed into "Other service workers,
n.e.c."), so I can't test Susskind's specific example directly. The
test is on the pattern, not the example.
...
not an automation story. Strip those out and the remaining
automation-driven disappearances number about six.
